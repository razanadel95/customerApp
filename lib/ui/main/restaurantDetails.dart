...
class _RestaurantDetailsScreenState extends State<RestaurantDetailsScreen> with SingleTickerProviderStateMixin {
  ...
  _children(){
    ...
    list.add(Container(
      ...
      child: IList1(imageAsset: "assets/star.png", text: (_this != null) ? _this.restaurant.name : "",                // name
    ...
    list.add(Container(
      margin: EdgeInsets.only(left: 20, right: 20),
      child: IList1(imageAsset: "assets/categories.png", text: strings.get(91),             // Products
        textStyle: theme.text16bold, imageColor: theme.colorDefaultText),
    ));
