...
class MapInfoScreen extends StatefulWidget {
  Function(double, double, String) callback;
...
class _MapInfoScreenState extends State<MapInfoScreen> {
  ...
  _onMapTap(LatLng pos) async {
    PlacesSearchResponse response = await places.searchNearbyWithRadius(new Location(pos.latitude, pos.longitude), 20);
    _textAddress = "";
...
//        _textAddress = response.results[1].vicinity;
//      else
//        _textAddress = response.results[0].vicinity;
    }
    setState(() {
    });
  }
